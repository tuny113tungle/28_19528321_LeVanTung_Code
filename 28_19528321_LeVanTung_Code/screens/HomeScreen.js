            ...
            <View style={styles.homeSc}>
                <View style={styles.topsc1}>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.MayBe}>
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/xedap4.png')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                            ...
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/xedap6.jpg')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('Hổ Đông Dương') }}
                                >
                                    <View style={styles.btnAdd}>
                                        <Text style={styles.txtct1}>
                                            Pina Mount
                        ...
                        <View style={styles.MayBe02}>
                            <View style={styles.chitiet1}>
                                ...
                                />
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('Alagoas Cuasows') }}
                                >
                                    <View style={styles.btnAdd}>
                                        <Text style={styles.txtct1}>
                                            Alagoas 
                            ...
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/xedap8.jpg')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
                        ...
                        <View style={styles.MayBe02}>
                            <View style={styles.chitiet1}>
                                <Image source={require('./images/xedap10.jpg')}
                                    style={styles.imgTx}
                                />
                                <TouchableOpacity
                                >
